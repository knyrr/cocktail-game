...
public class CocktailClientTest {
    ...
    void setUp() throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        ...
        cocktailClient = new CocktailClient(restTemplate, objectMapper);

        Field apiUrlField = CocktailClient.class.getDeclaredField("apiUrl");
        apiUrlField.setAccessible(true);
        apiUrlField.set(cocktailClient, apiUrl);
    }
    ...
    void testGetCocktail_Success() throws Exception {
        ...
        when(objectMapper.readValue(jsonResponse, DrinkResponse.class)).thenReturn(drinkResponse);
